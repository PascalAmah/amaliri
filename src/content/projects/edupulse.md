...
architecture:
  - label: "Django"
    detail: "Backend application"
  - label: "Django REST Framework"
    detail: "REST API layer"
  - label: "MySQL"
    detail: "Relational data storage"
  - label: "REST APIs"
    detail: "Authentication, lessons, quizzes & progress"
